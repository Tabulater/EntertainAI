  ...
  return (
    <ErrorBoundary>
      <div className="fixed inset-0 bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 z-50">
        ...
        {/* Main Content */}
        <div className="pt-20 h-full flex items-center justify-center p-4">
          <div className="relative w-full h-[80vh] max-w-6xl rounded-xl overflow-hidden bg-black/30 border border-white/10">
            {activeTab === 'trailer' ? (
              <iframe
